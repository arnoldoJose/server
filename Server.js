...
const { connection, emitMessage,messageReturn } = require("./clasSocket/conectionSocket");
const { conectionDB } = require("./DB/DBConnect");
const { createLoans,updateLoans } = require('./CaseLoans/loansController');
...
app.post("/create/loan",(req,res) => createLoans.createReservation(req,res,io,emitMessage));

app.post("/admin/loan", (req,res) => createLoans.createAdminLoan(req,res,io,emitMessage));

app.put('/update/loan/:id',(req,res) => updateLoans.updateLoan(req,res,io,messageReturn))
